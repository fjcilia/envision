...
Only requiring some minor changes is envision.cpp.
...
Changes to envision.cpp
----------------------
envision.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
