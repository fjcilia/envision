...
git clone https://github.com/envisionpay/envision
```
...
```bash
    ...
    From https://github.com/envisionpay/envision
...
[envision/gitian.sigs](https://github.com/envisionpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
