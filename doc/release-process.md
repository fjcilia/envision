...
* Update translations, see [translation_process.md](https://github.com/bmyatt/envision/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/bmyatt/gitian.sigs.git
...
### Build and sign Envision Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit envision=v${VERSION} ../envision/contrib/gitian-descriptors/gitian-osx.yml
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [envision-detached-sigs](https://github.com/bmyatt/envision-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Envision-development mailing list

  - Update title of #bmyatt on Freenode IRC
