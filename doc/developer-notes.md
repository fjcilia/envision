...
Envision Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Envision Core, where everyone uses
...
pay attention to for reviewers of Envision Core code.

General Envision Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Envision Core uses tinyformat, which is type safe. Leave them out to avoid confusion
