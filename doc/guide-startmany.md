...
[From the envision github repo](https://github.com/envisionpay/envision/blob/master/doc/masternode_conf.md)
...
## Update envision.conf on server

If you generated a new masternode private key, you will need to update the remote `envision.conf` files.

Shut down the daemon and then edit the file.

```nano .envisioncore/envision.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `envision.conf` file.
...
```envision-cli getinfo```

and comparing with the official explorer at https://explorer.envision.org/chain/Envision
...
```
envision-cli masternode status
{
...
Search your Masternodes on https://envisionninja.pl/masternodes.html
