...
#define BOOST_TEST_MODULE Envision Test Suite

#include "test_envision.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_envision_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
