...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EnvisionNetwork") type = EnvisionNetwork;
    if(strType == "EnvisionNetworkVariable") type = EnvisionNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EnvisionNetwork) s = "EnvisionNetwork";
    if(type == EnvisionNetworkVariable) s = "EnvisionNetworkVariable";
