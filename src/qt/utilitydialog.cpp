    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Envision Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Envision Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  envision-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Envision in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://envisionpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://envisionpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Envision Core is shutting down...") + "<br /><br />" +
