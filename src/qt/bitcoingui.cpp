    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Envision Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Envision address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and envision: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Envision Core"), this);
    aboutAction->setStatusTip(tr("Show information about Envision Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Envision Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Envision addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Envision addresses"));
    ...
    openAction->setStatusTip(tr("Open a envision: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Envision Core help message to get a list with possible Envision Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Envision Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Envision network", "", count));
    } else {
...
{
    QString strTitle = tr("Envision Core"); // default title
